...
public class CommandRegister implements Initable {
    ...
    public void start() {
        ...
        commandManager.registerCommand(new GrimOffDam());
        ...
        commandManager.registerCommand(new GrimSwapHB());
        commandManager.registerCommand(new GrimKnockBack());
        commandManager.registerCommand(new GrimRoteblo());
    }
}
