...
@CheckData(name = "StealerA", setback = 1)
public class StealerA extends Check implements PacketCheck {

    public StealerA(GrimPlayer player) {
        super(player);
    }
    ...
    public void onPacketReceive(PacketReceiveEvent event) {
        if (event.getPacketType() == PacketType.Play.Client.CLICK_WINDOW) {
            ...
            if (currentTime - lastClickTime < 1000) {
                ...
                if (clickCount > 80 && shouldModifyPackets()) {
